...
$appVendor = "Oracle"
$appName = "Java Version 8 Update 192"
$appVersion = [Version]"8.0.192"
$appArch = ""
$appLang = "EN"
$appRevision = "01"
$appScriptVersion = "1.1.0"
$appScriptDate = "10/17/2018"
$appScriptAuthor = "Matthew Harding"
...
#*===============================================
    ...
    Remove-MSIApplications "Java 8 Update 181"

    Remove-MSIApplications "Java 8 Update 172"

    Remove-MSIApplications "Java Web Start"

    Remove-MSIApplications "Java 8 Update 181 (64-bit)"

    Remove-MSIApplications "Java 8 Update 101"

    Remove-MSIApplications "Java 8 Update 111"

    Remove-MSIApplications "Java 8 Update 121"

    Remove-MSIApplications "Java 8 Update 171"

    Remove-MSIApplications "Java 8 Update 161"

    Remove-MSIApplications "Java 7 Update 80"

    Remove-MSIApplications "JavaFX 2.1.1"

    Remove-MSIApplications "Java 8 Update 77"

    Remove-MSIApplications "Java 8 Update 73"

    Remove-MSIApplications "Java 8 Update 172 (64-bit)"

    Remove-MSIApplications "Java 8 Update 112"
...
#*===============================================
    ...
    If ($is64Bit) {
        ...
        Execute-Process -FilePath "jre-8u192-windows-i586.exe" -Arguments "/s" -WindowStyle Hidden
        ...
        Write-Log "Architecture not identified. Installation will abort"
